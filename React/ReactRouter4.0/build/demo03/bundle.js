...
var OldSchoolMenuLink = function (_React$Component3) {
    _inherits(OldSchoolMenuLink, _React$Component3);

    function OldSchoolMenuLink(props) {
        _classCallCheck(this, OldSchoolMenuLink);

        return _possibleConstructorReturn(this, (OldSchoolMenuLink.__proto__ || Object.getPrototypeOf(OldSchoolMenuLink)).call(this, props));
    }

    _createClass(OldSchoolMenuLink, [{
        key: 'render',
        value: function render() {
            // 获取参数配置：
            // 1.label：当前链接名字
            ...
            return _react2.default.createElement(_reactRouterDom.Route, { path: to, exact: activeOnlyWhenExact, children: function children(_ref) {
...
var CustomLinkExample = function (_React$Component4) {
    _inherits(CustomLinkExample, _React$Component4);

    function CustomLinkExample(props) {
        _classCallCheck(this, CustomLinkExample);

        return _possibleConstructorReturn(this, (CustomLinkExample.__proto__ || Object.getPrototypeOf(CustomLinkExample)).call(this, props));
    }

    _createClass(CustomLinkExample, [{
        key: 'render',
        value: function render() {
            // 设置传递参数的值
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(OldSchoolMenuLink, { activeOnlyWhenExact: true, to: '/', label: 'Home' }),
                _react2.default.createElement(OldSchoolMenuLink, { to: '/about', label: 'About' }),
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    null,
    _react2.default.createElement(CustomLinkExample, null)
