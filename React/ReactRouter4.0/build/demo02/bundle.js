...
var FakeAuth = function () {
    function FakeAuth() {
        _classCallCheck(this, FakeAuth);
    }

    // 静态方法：已成功登录


    _createClass(FakeAuth, null, [{
        key: 'authenticate',
...
var Public = function (_React$Component) {
    ...
    function Public(props) {
        ...
        return _possibleConstructorReturn(this, (Public.__proto__ || Object.getPrototypeOf(Public)).call(this, props));
    }
...
var Protected = function (_React$Component2) {
    _inherits(Protected, _React$Component2);

    function Protected(props) {
        _classCallCheck(this, Protected);

        return _possibleConstructorReturn(this, (Protected.__proto__ || Object.getPrototypeOf(Protected)).call(this, props));
    }
...
var AuthButton = (0, _reactRouterDom.withRouter)(function (_ref) {
    ...
    return _react2.default.createElement(
        'div',
        null,
        FakeAuth.isAuthenticated ? _react2.default.createElement(
            'p',
            null,
            '\u767B\u5F55\u6210\u529F!',
...
var PrivateRoute = function (_React$Component3) {
    _inherits(PrivateRoute, _React$Component3);
    ...
    _createClass(PrivateRoute, [{
        key: 'render',
        value: function render() {
            return FakeAuth.isAuthenticated ? _react2.default.createElement(_reactRouterDom.Route, { path: this.props.path, component: Protected }) : _react2.default.createElement(_reactRouterDom.Redirect, { to: {
                    pathname: '/login',
...
var Login = function (_React$Component4) {
    ...
    _createClass(Login, [{
        ...
        value: function render() {
            ...
            var _ref2 = this.props.location.state || { from: '/' },
                from = _ref2.from;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(PrivateRoute, { path: '/protected' })
                )
            );
        }
    }]);
