...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } /*
                                                                                                                                                          * 每个逻辑“路线”有两个组件，一个用于边栏，一个用于主要地区。
                                                                                                                                                          * 我们希望在路径与当前URL匹配时将它们呈现在不同的位置。
                                                                                                                                                          * */
...
var SidebarExample = function (_React$Component) {
    _inherits(SidebarExample, _React$Component);

    function SidebarExample(props) {
        _classCallCheck(this, SidebarExample);

        return _possibleConstructorReturn(this, (SidebarExample.__proto__ || Object.getPrototypeOf(SidebarExample)).call(this, props));
    }
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    null,
    _react2.default.createElement(SidebarExample, null)
