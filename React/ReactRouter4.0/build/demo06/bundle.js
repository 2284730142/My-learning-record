...
var Person = function (_React$Component) {
    ...
    function Person(props) {
        ...
        _this.PEEPS = [{ id: 0, name: 'Michelle', friends: [1, 2, 3] }, { id: 1, name: 'Sean', friends: [0, 3] }, { id: 2, name: 'Kim', friends: [0, 1, 3] }, { id: 3, name: 'David', friends: [1, 2] }];
        return _this;
    }
    ...
    _createClass(Person, [{
        ...
        value: function find(id) {
            if (!isNaN(id)) {
                return this.PEEPS.find(function (p) {
                    return p.id == id;
                });
            } else {
                return this.PEEPS[0];
        ...
        value: function render() {
            ...
            var person = this.find(this.props.match.params.id);
            console.log(person);
                    ...
                    person.friends.map(function (id) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { to: _this2.props.match.url + '/' + id },
                                _this2.find(id).name
                            )
                        );
                    })
                ),
                _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match.url + '/:id', component: Person })
            );
        }
    }]);
...
var RecursiveExample = function (_React$Component2) {
    _inherits(RecursiveExample, _React$Component2);

    function RecursiveExample(props) {
        _classCallCheck(this, RecursiveExample);

        return _possibleConstructorReturn(this, (RecursiveExample.__proto__ || Object.getPrototypeOf(RecursiveExample)).call(this, props));
    }

    _createClass(RecursiveExample, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(Person, { match: { params: { id: 0 }, url: '' } });
        }
    }]);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    null,
    _react2.default.createElement(RecursiveExample, null)
